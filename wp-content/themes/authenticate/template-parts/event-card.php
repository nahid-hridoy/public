...
<div class="col-sm-6 col-lg-4 d-flex flex-direction-column">
    <div class="article-card">
        ...
        <?php 
            ...
            $ev_excerpt = get_the_excerpt( $postid );
        ?>
        ...
        <h4 class="article-title event-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
        <?php echo mb_strimwidth( $ev_excerpt, 0, 160, '...' ); ?>
        </div>
