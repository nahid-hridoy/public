<?php
    ...
    $day_val = get_field( 'session_type' );
    $day_val = $day_val['label'];
...
<div class="col-12 col-sm-6 col-lg-4 col-xl-3 flex-direction-column filter session_card mix <?php echo $day_val;?>">
